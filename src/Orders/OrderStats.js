...
const OrderStats = () => {
  ...
  // Set default dates: end date as today, start date as 3 days back
  ...
  const getOrderStats = () => {
    ...
    axios
      .get(
        BASE_URL +
          `order-service/notification_to_dev_team_weekly?endDate=${formattedEndDate}&startDate=${formattedStartDate}&status=${orderStatus}`
      )
          ...
          <>
            ...
            <View style={styles.card}>
              ...
              <TouchableOpacity
                ...
                onPress={getOrderStats}
                disabled={loading}
              >
                <Icon name="refresh" size={20} color="#fff" />
                <Text style={styles.getDataButtonText}>
            ...
            <View style={styles.card}>
              <TouchableOpacity
                ...
                onPress={() => setRevenueOpen(!revenueOpen)}
              >
                <Text style={[styles.cardTitle, { color: "#0384d5" }]}>
                  Revenue Summary
                </Text>
              ...
              {selectedDateData && (
                <View style={styles.selectedDateContainer}>
                  <Text style={styles.selectedDateTitle}>
                    {moment(selectedDateData.date).format("DD MMM YYYY")}{" "}
                    Details
                  </Text>
                  <View style={styles.selectedDateRow}>
                    <View style={styles.selectedDateItem}>
                      ...
                      <Text style={styles.selectedDateCount}>
                        {selectedDateData.codCount} orders
                      </Text>
                    </View>
                    <View style={styles.selectedDateItem}>
                      ...
                      <Text
                        style={[styles.selectedDateValue, styles.onlineText]}
                      >
                        {formatCurrency(selectedDateData.online)}
                      </Text>
                      <Text style={styles.selectedDateCount}>
                        {selectedDateData.onlineCount} orders
                      </Text>
                    </View>
                  </View>
                </View>
            ...
            <View style={styles.card}>
              <View style={styles.sectionHeader}>
                <Text style={[styles.cardTitle, { color: "#3d2a71" }]}>
                  Recent Orders
                </Text>
                  ...
                  <View style={styles.orderHeader}>
                    <View>
                      ...
                      <Text style={styles.orderDate}>
                        {moment(order.orderPlacedDate).format(
                          "DD MMM YYYY, hh:mm A"
                        )}
                      </Text>
                    </View>
