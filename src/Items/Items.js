...
const Items = () => {
  ...
  }, [searchQuery, items, activeFilter]);
        ...
        <View style={styles.dropdownContainer}>
          ...
          >
            <Text style={styles.dropdownButtonText}>
              {activeFilter} ({activeFilter === "All" ? counts.total : 
                activeFilter === "Active" ? counts.active : counts.inactive})
            </Text>
            <Icon name={dropdownVisible ? "arrow-drop-up" : "arrow-drop-down"} size={24} color={COLORS.primary} />
          </TouchableOpacity>
            ...
            <View style={styles.dropdownMenu}>
              ...
              >
                <Text style={[
                  ...
                  activeFilter === "All" && styles.dropdownItemTextActive
                ]}>All ({counts.total})</Text>
              </TouchableOpacity>
              ...
              >
                <Text style={[
                  styles.dropdownItemText,
                  activeFilter === "Active" && styles.dropdownItemTextActive
                ]}>Active ({counts.active})</Text>
              </TouchableOpacity>
              ...
              >
                <Text style={[
                  styles.dropdownItemText,
                  activeFilter === "Inactive" && styles.dropdownItemTextActive
                ]}>Inactive ({counts.inactive})</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
